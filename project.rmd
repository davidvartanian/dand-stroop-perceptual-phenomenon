...
The *null* hypothesis means that no changes would be seen after the testing.

$$H_a: \mu_c < \mu_i$$

The *alternative* hypothesis means that the *Congruent* test would spend
significantly less time to complete the test than the *Incongruent* test.
